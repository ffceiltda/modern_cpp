...
#   if (_MODERN_CPP_LANGUAGE_C_STANDARD_ >= _MODERN_CPP_LANGUAGE_C_STANDARD_99_) || (defined(_MSVC_TRADITIONAL) && (_MSVC_TRADITIONAL == 0))

#       define _MODERN_CPP_C_PREPROCESSOR_SUPPORT_VA_ARGS_

#   endif /* (_MODERN_CPP_LANGUAGE_C_STANDARD_ >= _MODERN_CPP_LANGUAGE_C_STANDARD_99_) || (defined(_MSVC_TRADITIONAL) && (_MSVC_TRADITIONAL == 0)) */

#else /* !defined(__cplusplus) */ 

#   if (_MODERN_CPP_LANGUAGE_CXX_STANDARD_ >= _MODERN_CPP_LANGUAGE_CXX_STANDARD_0X_)

#      define _MODERN_CPP_C_PREPROCESSOR_SUPPORT_VA_ARGS_

#   endif /* (_MODERN_CPP_LANGUAGE_CXX_STANDARD_ >= _MODERN_CPP_LANGUAGE_CXX_STANDARD_0X_) */
